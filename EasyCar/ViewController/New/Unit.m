...
+(id)EPStoryboard:(NSString *)viewControllerIdentifer{
	...
	UIStoryboard *EPStoryboard = [UIStoryboard storyboardWithName:@"EPStoryboard" bundle:nil];
	return [EPStoryboard instantiateViewControllerWithIdentifier:viewControllerIdentifer];
}
